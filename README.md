...
## DB Assignments  [![Build Status](https://travis-ci.org/github/Azizxon/db-assignments.svg?branch=master)](https://travis-ci.org/github/Azizxon/db-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'Azizxon'` with your account name).
...
```
* Open https://github.com/Azizxon/db-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
